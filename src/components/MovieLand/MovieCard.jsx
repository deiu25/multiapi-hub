...
const MovieCard = ({ movie, toggleFavorite, isFavorite }) => {
  return (
    <div className="w-full sm:w-[310px] h-[460px] relative rounded-xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 bg-gray-800">
      <button
        className={`absolute top-2 right-2 p-1 sm:p-2 rounded-full ${
      ...
      <div className="w-full h-full">
        <img
          ...
          src={movie.Poster !== "N/A" ? movie.Poster : "/no-poster.webp"}
          alt={movie.Title}
        />
      </div>
